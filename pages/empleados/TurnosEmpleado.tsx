...
const InicioEmpleado: React.FC = () => {
  ...
  // 🔄 Escuchar evento global "turno-actualizado"
  useEffect(() => {
    const handleUpdate = () => fetchTurnos();
    window.addEventListener("turno-actualizado", handleUpdate);
    return () => window.removeEventListener("turno-actualizado", handleUpdate);
  }, []);
  ...
  // ✅ Configuración estable de vistas
